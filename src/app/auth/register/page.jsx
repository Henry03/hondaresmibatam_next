...
export default function Register () {
    ...
    const handleRegister = (e) => {
        ...
        axiosInstance.post('/api/v1/auth/register', input)
            ...
            <div className="relative flex items-center justify-center px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-base-100 shadow-base-300/20 z-1 w-full space-y-6 rounded-xl p-6 shadow-md sm:min-w-md lg:p-8">
                    <div className="flex items-center gap-3">
                        <Image src={hondaLogo} className="h-8 w-fit" alt="brand-logo" />
                    </div>
                    <div>
                        <h3 className="text-base-content mb-1.5 text-2xl font-semibold">Register new account</h3>
                        <p className="text-base-content/80">Ship Faster and Focus on Growth.</p>
                    </div>
                    <div className="space-y-4">
                        <form className="mb-4 space-y-4" onSubmit={(e)=>handleRegister(e)}>
                            <div className="">
                                <label className="label label-text" htmlFor="name"> Name </label>
                                <input type="text" placeholder="Type your Name" className={`input ${errors?.name ? "is-invalid" : null}`} id="name" value={name} onChange={(e) => setName(e.target.value)}/>
                                {
                                    errors?.name &&
                            ...
                            <div className="">
                                ...
                                <input type="text" placeholder="Type your username" className={`input ${errors?.username ? "is-invalid" : null}`} id="username" value={username} onChange={(e) => setUsername(e.target.value)}/>
                                {
                                    errors?.username &&
                                    <span className="helper-text">{errors.username[0]}</span>
                                }
                            </div>
                            <div>
                                <label className="label-text" htmlFor="userPassword">Password</label>
                                <div className="input">
                                    <input id="userPassword" type="password" placeholder="············" className={`${errors?.password ? "is-invalid" : null}`} value={password} onChange={(e) => setPassword(e.target.value)}/>
                                    <button
                                        type="button"
                                ...
                                {
                                    errors?.password &&
                                    <span className="helper-text">{errors.password[0]}</span>
                                }
                            </div>
                            <div>
                                <label className="label-text" htmlFor="userPasswordConfirmation">Password Confirmation</label>
                                <div className="input">
                                    <input id="userPasswordConfirmation" type="password" placeholder="············" className={`${errors?.passwordConfirmation ? "is-invalid" : null}`} value={passwordConfirmation} onChange={(e) => setPasswordConfirmation(e.target.value)}/>
                                    <button
                                        type="button"
                                        data-toggle-password='{ "target": "#userPasswordConfirmation" }'
                                        className="block cursor-pointer"
                                        aria-label="userPasswordConfirmation"
                                        >
                                        <span className="icon-[tabler--eye] password-active:block hidden size-5 shrink-0"></span>
                                        <span className="icon-[tabler--eye-off] password-active:hidden block size-5 shrink-0"></span>
                                    </button>
                                </div>
                                {
                                    ...
                                    <span className="helper-text">{errors.passwordConfirmation[0]}</span>
                                }
                            </div>
                            <div className="">
                                <label className="label label-text" htmlFor="verification"> Verification Code </label>
                                <input type="text" placeholder="Type your code" className={`input ${errors?.verificationCode ? "is-invalid" : null}`} id="verification" value={verificationCode} onChange={(e) => setVerificationCode(e.target.value)}/>
                                {
                                    errors?.verificationCode &&
                                    <span className="helper-text">{errors.verificationCode[0]}</span>
                                }
                            </div>
                            <button className="btn btn-lg btn-primary btn-gradient btn-block">Register</button>
                        </form>
                        <p className="text-base-content/80 mb-4 text-center">
                            Already has an account?
                            <Link href="/auth/login" className="link link-animated link-primary font-normal">
                                Login here
                            </Link>
                        </p>
                    </div>
